module.exports = {
  ...
  default: {
    ...
    rpcCorsDomain: { // Domains from which to accept cross origin requests (browser enforced). This can also be a comma separated list
      ...
      additionalCors: ["https://ipfs.infura.io","http://localhost:8000","http://localhost:8500","embark"] // Additional CORS domains to add to the list. If "auto" is false, only those will be added
    },
    wsRPC: true, // Enable the WS-RPC server
    wsOrigins: { // Same thing as "rpcCorsDomain", but for WS origins
      auto: true,
      additionalCors: ["https://ipfs.infura.io","http://localhost:8000","http://localhost:8500","embark"]
    },
